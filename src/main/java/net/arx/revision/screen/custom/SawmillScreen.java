...
public class SawmillScreen extends HandledScreen<SawmillScreenHandler> {
    ...
    private static final Identifier TEXTURE = Identifier.of("revision", "textures/gui/sawmill.png");
    // 👆 place a PNG in assets/revision/textures/gui/sawmill.png
